...
function get_simple_likes_button( $post_id, $is_comment = NULL ) {
	...
	if ( already_liked( $post_id, $is_comment ) ) {
		...
		$title = __( 'NICHT GEFALLEN', 'lr' );
		$icon = $icon_full;
	} else {
		$class = '';
		$title = __( 'GEFALLEN', 'lr' );
		$icon = $icon_empty;
	}
...
function get_liked_icon() {
	...
	$icon = '<span class="sl-icon"><svg width="20" height="20" viewBox="0 0 20 20" fill="#F76147" xmlns="http://www.w3.org/2000/svg"><path d="M10.517 17.3417C10.2337 17.4417 9.76699 17.4417 9.48366 17.3417C7.06699 16.5167 1.66699 13.075 1.66699 7.24171C1.66699 4.66671 3.74199 2.58337 6.30033 2.58337C7.81699 2.58337 9.15866 3.31671 10.0003 4.45004C10.842 3.31671 12.192 2.58337 13.7003 2.58337C16.2587 2.58337 18.3337 4.66671 18.3337 7.24171C18.3337 13.075 12.9337 16.5167 10.517 17.3417Z" stroke="#F76147" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>';
	return $icon;
} // get_liked_icon()
...
function get_unliked_icon() {
	...
	$icon = '<span class="sl-icon"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.517 17.3417C10.2337 17.4417 9.76699 17.4417 9.48366 17.3417C7.06699 16.5167 1.66699 13.075 1.66699 7.24171C1.66699 4.66671 3.74199 2.58337 6.30033 2.58337C7.81699 2.58337 9.15866 3.31671 10.0003 4.45004C10.842 3.31671 12.192 2.58337 13.7003 2.58337C16.2587 2.58337 18.3337 4.66671 18.3337 7.24171C18.3337 13.075 12.9337 16.5167 10.517 17.3417Z" stroke="#141414" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>';
	return $icon;
} // get_unliked_icon()
